...
- **Don't** use Claude's `continue_editing` for Reel video content — use Ken Burns background video (avatar-video Reels via Argil are no longer available; Argil was retired in gateway v1.7.4 with no replacement)
